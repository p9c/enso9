...
func Art(w http.ResponseWriter, r *http.Request) {
	...
	tmpl, _ := template.New("").ParseFiles("./tpl/amp/art.gohtml", "./tpl/amp/amp.gohtml", "./tpl/amp/inc/footer.gohtml", "./tpl/amp/inc/header.gohtml", "./tpl/amp/svgs.gohtml", "./tpl/amp/base.gohtml", "./tpl/amp/style.css")
